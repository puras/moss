...
@app.route('/api/kb/<int:kb_id>/update', methods=['POST'])
def update_kb(kb_id):
    """更新知识库信息"""
    try:
        data = request.get_json()
...
@app.route('/api/kb/<int:kb_id>/delete', methods=['POST'])
def delete_kb(kb_id):
    """删除知识库"""
    try:
        with get_session() as db:
...
@app.route('/api/kb/<int:kb_id>/files', methods=['GET'])
...
@app.route('/api/kb/<int:kb_id>/files', methods=['POST'])
...
@app.route('/api/kb/<int:kb_id>/files/<int:file_id>/delete', methods=['POST'])
