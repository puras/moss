...
def split_text_by_semantic(text, max_length, similarity_threshold=0.5):
    ...
    """
    # 加载BERT模型和分词器
    tokenizer = BertTokenizer.from_pretrained(pretrained_model_name_or_path='/Users/puras/workspace/proj/moss/models/bert-base-chinese/')
    model = BertModel.from_pretrained(pretrained_model_name_or_path='/Users/puras/workspace/proj/moss/models/bert-base-chinese/')
