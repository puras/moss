...
save_model_name = "DeepSeek-R1-Distill-Qwen-7B-moss"
bit_save_model_name = "DeepSeek-R1-Distill-Qwen-7B-moss__q4_k_m"
...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    cache_dir = "/data/moss/huggingface/hub/",
    # model_name = "unsloth/Qwen2.5-3B-Instruct-unsloth-bnb-4bit", # Choose ANY! eg mistralai/Mistral-7B-Instruct-v0.2
    ...
    for ds, frac in dataset_mixer.items():
        ...
        for split in splits:
            try:
                ...
                dataset = load_dataset(ds, split=split, cache_dir="/data/moss/huggingface/datasets/")
...
model.save_pretrained_gguf(bit_save_model_name, tokenizer, quantization_method = "q4_k_m")
